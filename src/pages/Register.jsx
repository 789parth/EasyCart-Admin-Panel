      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-lg border border-gray-100">
        ...
        <div>
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2563EB] disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors"
          >
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="font-medium text-[#2563EB] hover:text-blue-700 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
